...
#   bash config/playback.sh <bag_directory> [--rate <speed>]
#
# Examples:
#   bash config/playback.sh humble_ws/bags/slam_20250301_143022
#   bash config/playback.sh humble_ws/bags/slam_20250301_143022 --rate 2.0
